...
def rebuild_sheet():
    ...
    try:
        ...
        def wt(name, header, rows, hc):
            ...
            s.freeze(rows=1); time.sleep(10)

        wt("Homework",["Grade","Subject","Assignment","Due Date","Teacher","Type","Notes","Status"],[
            ["KG1","Activities","Color the butterfly worksheet","2026-09-23","Ms. Noha","Coloring","Use crayons","Active"],["KG1","Arabic","Trace letters page 5","2026-09-24","Ms. Fatima","Tracing","Pencil only","Active"],
            ["KG2","English","Write your name 3 times","2026-09-23","Ms. Sara","Writing","","Active"],["KG2","Math","Count and circle groups of 5 page 8","2026-09-24","Ms. Noha","Worksheet","","Active"],
            ["Grade 1","Math","Addition up to 20 workbook page 14-15","2026-09-23","Ms. Hana","Workbook","","Active"],["Grade 1","Arabic","Read lesson 2 answer questions 1-3","2026-09-24","Mr. Tarek","Reading","Handwritten","Active"],["Grade 1","English","Write 5 sentences: cat dog sun run big","2026-09-25","Ms. Sara","Writing","","Active"],
            ["Grade 2","Math","Subtraction worksheet page 22 Qs 1-10","2026-09-23","Ms. Hana","Worksheet","","Active"],["Grade 2","Arabic","Memorize poem page 18 4 lines","2026-09-24","Mr. Tarek","Memorization","","Active"],["Grade 2","Science","Draw and label: sun cloud rain wind","2026-09-25","Ms. Hana","Drawing","Use colors","Active"],
            ["Grade 3","Math","Multiplication tables 3 and 4 page 30","2026-09-23","Ms. Hana","Tables","","Active"],["Grade 3","Arabic","Essay: My School 5 sentences minimum","2026-09-24","Mr. Tarek","Essay","Handwritten","Active"],["Grade 3","English","Read unit 3 story answer Qs 1-5","2026-09-25","Ms. Sara","Reading","","Active"],
            ["Grade 4","Math","Long division exercises page 45 Qs 1-8","2026-09-23","Ms. Hana","Exercises","Show work","Active"],["Grade 4","Science","Research 3 facts about the solar system","2026-09-24","Mr. Omar","Research","","Active"],["Grade 4","Arabic","Grammar identify nouns page 52","2026-09-25","Ms. Fatima","Grammar","","Active"],
            ["Grade 5","Math","Fractions practice page 52-53","2026-09-23","Ms. Hana","Workbook","","Active"],["Grade 5","Arabic","Read and summarize lesson 4","2026-09-24","Mr. Tarek","Summary","Handwritten","Active"],["Grade 5","English","Vocab 20 words memorize for Thursday","2026-09-25","Ms. Sara","Memorization","","Active"],["Grade 5","Science","Draw and label parts of a plant","2026-09-26","Ms. Hana","Drawing","Use colors","Active"],
            ["Grade 6","Math","Ratio and proportion page 61 Qs 1-12","2026-09-23","Mr. Khaled","Exercises","Show work","Active"],["Grade 6","Arabic","Essay importance of reading 150 words","2026-09-24","Ms. Fatima","Essay","Handwritten","Active"],["Grade 6","English","Read chapter 4 answer Qs 1-6","2026-09-25","Ms. Sara","Reading","","Active"],["Grade 6","Science","Water cycle report 1 page with diagram","2026-09-26","Mr. Omar","Report","Include diagram","Active"],
            ["Grade 7","Math","Chapter 4 exercises page 67 Qs 1-15","2026-09-23","Mr. Ahmed","Exercises","Bring calculator","Active"],["Grade 7","Arabic","Essay importance of education 200 words","2026-09-24","Ms. Fatima","Essay","Handwritten","Active"],["Grade 7","English","Read unit 5 pages 34-40","2026-09-25","Ms. Sara","Reading","","Active"],["Grade 7","Science","Digestive system report 1 page","2026-09-26","Mr. Omar","Report","","Active"],["Grade 7","Social Studies","Study chapter 6 for quiz Thursday","2026-09-25","Ms. Nadia","Study","","Active"],["Grade 7","French","Vocab list unit 2 - 15 words","2026-09-24","Ms. Claire","Memorization","","Active"],
            ["Grade 8","Math","Algebra equations page 44","2026-09-23","Mr. Khaled","Worksheet","Show steps","Active"],["Grade 8","Physics","Lab report electricity experiment","2026-09-24","Mr. Hassan","Lab Report","Include diagrams","Active"],["Grade 8","English","Finish chapter 7 - 10 lines summary","2026-09-25","Ms. Sara","Reading","","Active"],["Grade 8","Chemistry","Study periodic table groups 1-3 quiz Sunday","2026-09-28","Mr. Hassan","Study","","Active"],["Grade 8","Biology","Draw and label cell animal and plant","2026-09-26","Mr. Omar","Drawing","Use colors","Active"],
            ["Grade 9","Math","Quadratic equations page 78 Qs 1-10","2026-09-23","Mr. Ahmed","Worksheet","Show steps","Active"],["Grade 9","Physics","Newton laws summarize 2 examples each","2026-09-24","Mr. Hassan","Summary","","Active"],["Grade 9","Arabic","Literary analysis poem page 90","2026-09-25","Ms. Fatima","Analysis","Handwritten","Active"],["Grade 9","Chemistry","Balancing equations worksheet page 55","2026-09-26","Mr. Hassan","Worksheet","Show work","Active"],
            ["Grade 10","Math","Trigonometry page 92 Qs 1-8","2026-09-23","Mr. Ahmed","Exercises","Use calculator","Active"],["Grade 10","Physics","Momentum and energy page 110 Qs 1-5","2026-09-24","Mr. Hassan","Problems","Show solution","Active"],["Grade 10","English","300-word essay social media pros cons","2026-09-25","Ms. Sara","Essay","Typed","Active"],
            ["Grade 11","Math","Calculus differentiation chapter 3","2026-09-23","Mr. Ahmed","Exercises","Show steps","Active"],["Grade 11","Chemistry","Organic naming compounds worksheet","2026-09-24","Mr. Hassan","Worksheet","","Active"],["Grade 11","Arabic","Research Egyptian literary figure 2 pages","2026-09-25","Ms. Fatima","Research","Handwritten","Active"],
            ["Grade 12","Math","Past exam paper 2025 full attempt","2026-09-23","Mr. Ahmed","Exam Practice","Timed 3 hours","Active"],["Grade 12","Physics","Revision electricity chapter summary","2026-09-24","Mr. Hassan","Revision","","Active"],["Grade 12","English","University application essay","2026-09-25","Ms. Sara","Essay","500 words","Active"],
        ],"#0F1C2E")
        ...
        wt("Parents",["Name","Phone","Grade","Active","Student ID","Student Name","Relationship"],[
            ["Hany El-Shafei","201506667788","KG1","yes","STU001","Lina Hany El-Shafei","Father"],["Sherif Mansour","201607001122","KG1","yes","STU002","Adam Sherif Mansour","Father"],
            ["Adel Nasser","201118900880","KG2","yes","STU003","Kareem Adel Nasser","Father"],["Wael Ibrahim","201203110044","KG2","yes","STU004","Nada Wael Ibrahim","Father"],
            ["Bassem Reda","201223334455","Grade 1","yes","STU005","Youssef Bassem Reda","Father"],["Ibrahim Mostafa","201556667788","Grade 1","yes","STU006","Salma Ibrahim Mostafa","Father"],
            ["Magdy Helal","201203334455","Grade 2","yes","STU007","Fares Magdy Helal","Father"],["Osama Shawky","201990001122","Grade 2","yes","STU008","Rana Osama Shawky","Father"],
            ["Sherif Gouda","201405556677","Grade 3","yes","STU009","Adam Sherif Gouda","Father"],["Khaled Abdallah","201778889900","Grade 3","yes","STU010","Noura Khaled Abdallah","Father"],
            ["Tarek Samir","201112223344","Grade 4","yes","STU011","Salma Tarek Samir","Father"],["Ehab Mansour","201102223334","Grade 4","yes","STU012","Karim Ehab Mansour","Father"],
            ["Sayed Hassan","201035551012","Grade 5","yes","STU013","Esraa Sayed Hassan","Father"],["Amr El-Sayed","201445556677","Grade 5","yes","STU014","Ziad Amr El-Sayed","Father"],
            ["Hassan Farouk","201334445566","Grade 5","yes","STU015","Mariam Hassan Farouk","Father"],
            ["Nader El-Masry","201001112233","Grade 6","yes","STU016","Dina Nader El-Masry","Father"],["Taher Barakat","201607778899","Grade 6","yes","STU017","Hassan Taher Barakat","Father"],
            ["Mohamed Hassan","201118900880","Grade 7","yes","STU018","Ahmed Mohamed Hassan","Father"],["Walid Farouk","201334440066","Grade 7","yes","STU019","Hana Walid Farouk","Father"],
            ["Youssef Ali","201007778888","Grade 7","yes","STU021","Omar Youssef Ali","Father"],
            ["Ahmed Ibrahim","201234567890","Grade 8","yes","STU022","Nour Ahmed Ibrahim","Father"],["Sameh Fathy","201889990011","Grade 8","yes","STU023","Mahmoud Sameh Fathy","Father"],
        ...
        wt("exam",["Student ID","Student Name","Grade","Subject","Score","Total","Percentage","Grade Letter","Rank","Exam Date","Term","Teacher Notes"],[
            ["STU018","Ahmed Mohamed Hassan","Grade 7","Math",95,100,"95%","A","1st","2026-09-15","Term 1","Excellent"],["STU018","Ahmed Mohamed Hassan","Grade 7","Arabic",88,100,"88%","B+","3rd","2026-09-15","Term 1","Good essay"],["STU018","Ahmed Mohamed Hassan","Grade 7","English",92,100,"92%","A-","2nd","2026-09-15","Term 1","Strong comprehension"],["STU018","Ahmed Mohamed Hassan","Grade 7","Science",85,100,"85%","B","4th","2026-09-15","Term 1","Needs lab practice"],["STU018","Ahmed Mohamed Hassan","Grade 7","Social Studies",79,100,"79%","C+","6th","2026-09-15","Term 1","Study maps"],
            ["STU021","Omar Youssef Ali","Grade 7","Math",98,100,"98%","A+","1st","2026-09-15","Term 1","Top of class"],["STU021","Omar Youssef Ali","Grade 7","Arabic",94,100,"94%","A","1st","2026-09-15","Term 1","Exceptional"],["STU021","Omar Youssef Ali","Grade 7","English",96,100,"96%","A","1st","2026-09-15","Term 1","Exceptional"],["STU021","Omar Youssef Ali","Grade 7","Science",91,100,"91%","A-","1st","2026-09-15","Term 1","Strong analytical"],
            ["STU022","Nour Ahmed Ibrahim","Grade 8","Math",78,100,"78%","C+","8th","2026-09-15","Term 1","Needs algebra"],["STU022","Nour Ahmed Ibrahim","Grade 8","Arabic",91,100,"91%","A-","2nd","2026-09-15","Term 1","Excellent writing"],["STU022","Nour Ahmed Ibrahim","Grade 8","English",84,100,"84%","B","5th","2026-09-15","Term 1","Good reader"],["STU022","Nour Ahmed Ibrahim","Grade 8","Physics",76,100,"76%","C+","9th","2026-09-15","Term 1","Review electricity"],["STU022","Nour Ahmed Ibrahim","Grade 8","Chemistry",82,100,"82%","B-","6th","2026-09-15","Term 1","Periodic table"],
            ["STU023","Mahmoud Sameh Fathy","Grade 8","Math",96,100,"96%","A","1st","2026-09-15","Term 1","Top of class"],["STU023","Mahmoud Sameh Fathy","Grade 8","Physics",90,100,"90%","A-","2nd","2026-09-15","Term 1","Excellent lab"],["STU023","Mahmoud Sameh Fathy","Grade 8","English",93,100,"93%","A","1st","2026-09-15","Term 1","Strong writing"],
            ["STU013","Esraa Sayed Hassan","Grade 5","Math",90,100,"90%","A-","2nd","2026-09-15","Term 1","Great improvement"],["STU013","Esraa Sayed Hassan","Grade 5","Arabic",83,100,"83%","B","4th","2026-09-15","Term 1","Good handwriting"],["STU013","Esraa Sayed Hassan","Grade 5","English",88,100,"88%","B+","3rd","2026-09-15","Term 1","Excellent vocab"],["STU013","Esraa Sayed Hassan","Grade 5","Science",77,100,"77%","C+","7th","2026-09-15","Term 1","Review plant unit"],
            ["STU025","Ali Hassan El-Gohary","Grade 9","Math",88,100,"88%","B+","3rd","2026-09-15","Term 1","Good problem solver"],["STU025","Ali Hassan El-Gohary","Grade 9","Physics",79,100,"79%","C+","7th","2026-09-15","Term 1","Review Newton"],["STU025","Ali Hassan El-Gohary","Grade 9","English",95,100,"95%","A","1st","2026-09-15","Term 1","Best in class"],["STU025","Ali Hassan El-Gohary","Grade 9","Arabic",92,100,"92%","A-","2nd","2026-09-15","Term 1","Strong literature"],["STU025","Ali Hassan El-Gohary","Grade 9","Chemistry",84,100,"84%","B","4th","2026-09-15","Term 1","Good lab work"],
            ["STU027","Marwa Tarek Helmy","Grade 10","Math",91,100,"91%","A-","2nd","2026-09-15","Term 1","Strong trig"],["STU027","Marwa Tarek Helmy","Grade 10","English",94,100,"94%","A","1st","2026-09-15","Term 1","Excellent writer"],["STU027","Marwa Tarek Helmy","Grade 10","Physics",82,100,"82%","B-","5th","2026-09-15","Term 1","Work on momentum"],
        ],"#065F46")
        ...
        wt("Fees",["Student ID","Student Name","Grade","Parent Name","Parent Phone","Total Fees","Amount Paid","Remaining","Payment Status","Next Payment Due","Last Payment Date","Days Present","Total School Days"],[
            ["STU001","Lina Hany El-Shafei","KG1","Hany El-Shafei","201506667788",42000,14000,28000,"On Track","2026-03-01","2025-11-01",17,20],["STU002","Adam Sherif Mansour","KG1","Sherif Mansour","201607001122",42000,42000,0,"Paid in Full","N/A","2025-09-01",19,20],
            ["STU003","Kareem Adel Nasser","KG2","Adel Nasser","201118900880",42000,21000,21000,"On Track","2026-03-01","2025-11-01",16,20],["STU004","Nada Wael Ibrahim","KG2","Wael Ibrahim","201203110044",42000,42000,0,"Paid in Full","N/A","2025-09-01",20,20],
            ["STU005","Youssef Bassem Reda","Grade 1","Bassem Reda","201223334455",48000,16000,32000,"On Track","2026-03-01","2025-11-01",18,20],["STU006","Salma Ibrahim Mostafa","Grade 1","Ibrahim Mostafa","201556667788",48000,48000,0,"Paid in Full","N/A","2025-09-20",20,20],
            ["STU007","Fares Magdy Helal","Grade 2","Magdy Helal","201203334455",48000,48000,0,"Paid in Full","N/A","2025-09-25",20,20],["STU008","Rana Osama Shawky","Grade 2","Osama Shawky","201990001122",48000,16000,32000,"Overdue","2025-12-15","2025-09-15",12,20],
            ["STU009","Adam Sherif Gouda","Grade 3","Sherif Gouda","201405556677",48000,32000,16000,"On Track","2026-03-01","2025-11-01",19,20],["STU010","Noura Khaled Abdallah","Grade 3","Khaled Abdallah","201778889900",48000,16000,32000,"Overdue","2025-11-01","2025-09-01",13,20],
            ["STU011","Salma Tarek Samir","Grade 4","Tarek Samir","201112223344",55000,55000,0,"Paid in Full","N/A","2025-09-15",20,20],["STU012","Karim Ehab Mansour","Grade 4","Ehab Mansour","201102223334",55000,36667,18333,"Payment Due Soon","2026-02-10","2025-10-10",16,20],
            ["STU013","Esraa Sayed Hassan","Grade 5","Sayed Hassan","201035551012",55000,36667,18333,"On Track","2026-03-01","2025-11-01",19,20],["STU014","Ziad Amr El-Sayed","Grade 5","Amr El-Sayed","201445556677",55000,36667,18333,"Payment Due Soon","2026-02-01","2025-10-20",17,20],["STU015","Mariam Hassan Farouk","Grade 5","Hassan Farouk","201334445566",55000,55000,0,"Paid in Full","N/A","2025-09-15",20,20],
            ["STU016","Dina Nader El-Masry","Grade 6","Nader El-Masry","201001112233",55000,36667,18333,"On Track","2026-03-01","2025-11-01",18,20],["STU017","Hassan Taher Barakat","Grade 6","Taher Barakat","201607778899",55000,55000,0,"Paid in Full","N/A","2025-09-01",20,20],
            ["STU018","Ahmed Mohamed Hassan","Grade 7","Mohamed Hassan","201118900880",62000,41334,20666,"On Track","2026-03-01","2025-11-01",18,20],["STU019","Hana Walid Farouk","Grade 7","Walid Farouk","201334440066",62000,41334,20666,"On Track","2026-03-01","2025-11-01",19,20],["STU020","Karim Nader Soliman","Grade 7","Nader Soliman","201001112234",62000,41334,20666,"On Track","2026-03-01","2025-11-01",20,20],["STU021","Omar Youssef Ali","Grade 7","Youssef Ali","201007778888",62000,62000,0,"Paid in Full","N/A","2025-10-01",20,20],
            ["STU022","Nour Ahmed Ibrahim","Grade 8","Ahmed Ibrahim","201234567890",62000,41334,20666,"Payment Due Soon","2026-02-15","2025-10-15",20,20],["STU023","Mahmoud Sameh Fathy","Grade 8","Sameh Fathy","201889990011",62000,62000,0,"Paid in Full","N/A","2025-10-05",20,20],["STU024","Layla Khaled Mahmoud","Grade 8","Khaled Mahmoud","201035551013",62000,20667,41333,"Overdue","2025-12-01","2025-09-01",14,20],
            ["STU025","Ali Hassan El-Gohary","Grade 9","Hassan El-Gohary","201667778899",62000,41334,20666,"On Track","2026-03-01","2025-11-01",18,20],["STU026","Sara Mostafa El-Khatib","Grade 9","Mostafa El-Khatib","201304445566",62000,20667,41333,"Overdue","2025-11-15","2025-09-10",11,20],
            ["STU027","Marwa Tarek Helmy","Grade 10","Tarek Helmy","201503334455",70000,46667,23333,"On Track","2026-03-01","2025-11-01",19,20],["STU028","Badr Amr Khalifa","Grade 10","Amr Khalifa","201604445566",70000,70000,0,"Paid in Full","N/A","2025-09-01",20,20],
            ["STU029","Nadia Sherif El-Wakil","Grade 11","Sherif El-Wakil","201705556677",70000,46667,23333,"Payment Due Soon","2026-02-20","2025-10-20",17,20],["STU030","Karim Hassan Sabry","Grade 11","Hassan Sabry","201806667788",70000,70000,0,"Paid in Full","N/A","2025-09-01",20,20],
            ["STU031","Farah Mahmoud Zaki","Grade 12","Mahmoud Zaki","201907778899",70000,70000,0,"Paid in Full","N/A","2025-09-01",20,20],["STU032","Omar Khaled El-Sayed","Grade 12","Khaled El-Sayed","201008889900",70000,23334,46666,"Overdue","2025-10-01","2025-09-01",15,20],
        ],"#92400E")
        ...
        wt("Canteen",["Category","Item","Description","Price","Available Days","Allergens","Halal"],[
            ...
            ["Main Meal","Molokhia Rice","Molokhia soup white rice",20,"Wednesday","None","Yes"],
            ["Main Meal","Grilled Kofta","Beef kofta bread salad",30,"Thursday","None","Yes"],
            ["Main Meal","Grilled Chicken","Quarter chicken rice bread",35,"Daily","None","Yes"],
            ["Snacks","Cheese Sandwich","Baladi bread white cheese tomato",12,"Daily","Gluten Dairy","Yes"],
            ["Snacks","Falafel Wrap","Falafel tahini veggies",12,"Daily","Gluten Sesame","Yes"],
            ["Snacks","Pizza Slice","Cheese pizza tomato mozzarella",20,"Daily","Gluten Dairy","Yes"],
            ["Snacks","Pasta Box","Pasta tomato sauce",18,"Daily","Gluten","Yes"],
            ["Drinks","Water Bottle","500ml chilled",5,"Daily","None","Yes"],
            ["Drinks","Fresh Juice","Orange or mango",15,"Daily","None","Yes"],
            ["Drinks","Chocolate Milk","200ml chocolate",12,"Daily","Dairy","Yes"],
            ["Drinks","Yogurt Drink","Activia yogurt",10,"Daily","Dairy","Yes"],
            ["Dessert","Fruit Cup","Fresh seasonal fruit",15,"Daily","None","Yes"],
            ["Dessert","Cake Slice","Homemade sponge cake",18,"Daily","Gluten Dairy Eggs","Yes"],
        ...
        wt("Admissions",["Item","Value"],[
            ...
            ["Available Grades","KG1 KG2 Grade 1 Grade 4 Grade 7"],["Waitlist Grades","Grade 3 Grade 6 Grade 10"],["Full Grades","Grade 5 Grade 8 Grade 11 Grade 12"],
            ["KG Fees","42000 EGP per year"],["Grade 1-3 Fees","48000 EGP per year"],["Grade 4-6 Fees","55000 EGP per year"],["Grade 7-9 Fees","62000 EGP per year"],["Grade 10-12 Fees","70000 EGP per year"],
            ["Registration Deposit","5000 EGP non-refundable"],["Payment Plan","3 installments per year"],
            ["Documents","Birth cert previous report card parent ID 4 photos medical cert"],["Process","Apply online submit docs assessment meeting decision in 5 days"],
            ["Location","El Yasmeen Compound Entrance 1 El Sheikh Zayed 6th October"],["Phone","02-3796-9155 / 02-3796-9166"],["WhatsApp","01066253331"],["Hours","Sun-Thu 7:30 AM - 2:30 PM"],
        ],"#047857")

        wt("HOW TO USE",["TAB","PURPOSE","WHO UPDATES","BOT USAGE","NOTE"],[
            ["Homework","Daily homework per grade","Class Teachers","Parents ask homework grade 7","Update daily"],["Students","Full student roster","Admin Office","All student data","Source of truth"],
            ["Parents","Parent WhatsApp numbers","Admin Office","WhatsApp broadcasts","Never delete rows"],["Schedule","Weekly timetable","Coordinator","Parents ask schedule grade 5","Update each term"],
            ["exam","Exam results per student","Subject Teachers","Parents ask STU018 results","Keep exact tab name"],["Fees","Fee and attendance data","Accounts Dept","Parents ask fees status","BOT TAB do not rename"],
            ["Announcements","School announcements","Admin Panel only","Auto WhatsApp broadcast","Via admin panel only"],["BusRoutes","Bus routes and times","Transport Dept","Parents ask bus route","BOT TAB do not rename"],
            ["Canteen","Daily menu and prices","Canteen Manager","Parents ask canteen menu","BOT TAB do not rename"],["Library","Book catalog","Librarian","Parents ask library books","BOT TAB do not rename"],
            ["Admissions","Enrollment info and fees","Admissions Office","Parents ask admissions","Update each year"],
            ["RULE 1","Never change column headers breaks the bot","","","CRITICAL"],["RULE 2","Student IDs: STU001 STU002 STU999","","","CRITICAL"],["RULE 3","Grade names: KG1 KG2 Grade 1 Grade 12","","","CRITICAL"],
            ["RULE 4","Date format: YYYY-MM-DD","","","CRITICAL"],["RULE 5","Active column: yes or no lowercase","","","CRITICAL"],["RULE 6","Payment Status: Paid in Full / On Track / Payment Due Soon / Overdue","","","CRITICAL"],
            ["RULE 7","Phone numbers include country code 201118900880 no plus sign","","","CRITICAL"],
        ],"#0F1C2E")

        return jsonify({"status":"ALL DONE","message":"10 tabs updated successfully"})
    except Exception as e:
        import traceback
