...
def rebuild_sheet():
    ...
    try:
        ...
        wt("exam",["Student ID","Student Name","Grade","Subject","Score","Total","Percentage","Grade Letter","Rank","Exam Date","Term","Teacher Notes"],[
            ...
            ["STU018","Ahmed Mohamed Hassan","Grade 7","Social Studies",79,100,"79%","C+","6th","2026-09-15","Term 1","Study maps"],
            ...
            ["STU021","Omar Youssef Ali","Grade 7","English",96,100,"96%","A","1st","2026-09-15","Term 1","Exceptional"],
            ["STU021","Omar Youssef Ali","Grade 7","Science",91,100,"91%","A-","1st","2026-09-15","Term 1","Strong analytical"],
            ["STU022","Nour Ahmed Ibrahim","Grade 8","Math",78,100,"78%","C+","8th","2026-09-15","Term 1","Needs algebra"],
            ...
            ["STU022","Nour Ahmed Ibrahim","Grade 8","Chemistry",82,100,"82%","B-","6th","2026-09-15","Term 1","Periodic table"],
            ["STU023","Mahmoud Sameh Fathy","Grade 8","Math",96,100,"96%","A","1st","2026-09-15","Term 1","Top of class"],
            ["STU023","Mahmoud Sameh Fathy","Grade 8","Physics",90,100,"90%","A-","2nd","2026-09-15","Term 1","Excellent lab"],
            ...
            ["STU013","Esraa Sayed Hassan","Grade 5","English",88,100,"88%","B+","3rd","2026-09-15","Term 1","Excellent vocab"],
            ...
            ["STU025","Ali Hassan El-Gohary","Grade 9","Physics",79,100,"79%","C+","7th","2026-09-15","Term 1","Review Newton"],
            ...
            ["STU027","Marwa Tarek Helmy","Grade 10","Math",91,100,"91%","A-","2nd","2026-09-15","Term 1","Strong trig"],
            ["STU027","Marwa Tarek Helmy","Grade 10","English",94,100,"94%","A","1st","2026-09-15","Term 1","Excellent writer"],
        ...
        wt("HOW TO USE",["TAB","PURPOSE","WHO UPDATES","BOT USAGE","NOTE"],[
            ...
            ["Schedule","Weekly timetable","Coordinator","Parents ask schedule grade 5","Update each term"],
            ...
            ["RULE 1","Never change column headers - breaks bot","","","CRITICAL"],
            ["RULE 2","Student IDs: STU001 STU002 ... STU999","","","CRITICAL"],
            ["RULE 3","Grade names: KG1 KG2 Grade 1 ... Grade 12","","","CRITICAL"],
            ["RULE 4","Date format: YYYY-MM-DD","","","CRITICAL"],
            ["RULE 5","Active column: yes or no lowercase","","","CRITICAL"],
