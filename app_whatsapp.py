...
def rebuild_sheet():
    ...
    try:
        ...
        def wtab(name, header, rows, hc):
            ...
            s.freeze(rows=1)
            time.sleep(8)
            results.append(f"{name}: {len(rows)} rows")

        wtab("Homework",["Grade","Subject","Assignment","Due Date","Teacher","Type","Notes","Status"],[
            ...
            ["Grade 9","Physics","Newton laws - summarize and give 2 examples each","2026-09-24","Mr. Hassan","Summary","","Active"],
            ...
            ["Grade 10","English","300-word argumentative essay: Social media pros and cons","2026-09-25","Ms. Sara","Essay","Typed preferred","Active"],
        ...
        wtab("Students",["Student ID","Full Name","Grade","Section","Gender","Parent Name","Parent Phone","Total Fees","Paid","Remaining","Payment Status","Next Due","Days Present","Days Absent","Attendance%","Bus Route","Active"],[
        ...
        wtab("Parents",["Name","Phone","Grade","Active","Student ID","Student Name","Relationship"],[
        ...
        wtab("exam",["Student ID","Student Name","Grade","Subject","Score","Total","Percentage","Grade Letter","Rank","Exam Date","Term","Teacher Notes"],[
            ...
            ["STU018","Ahmed Mohamed Hassan","Grade 7","Science",85,100,"85%","B","4th","2026-09-15","Term 1","Needs lab practice"],
            ...
            ["STU021","Omar Youssef Ali","Grade 7","Science",91,100,"91%","A-","1st","2026-09-15","Term 1","Strong analytical"],
            ...
            ["STU022","Nour Ahmed Ibrahim","Grade 8","Physics",76,100,"76%","C+","9th","2026-09-15","Term 1","Review electricity"],
            ["STU022","Nour Ahmed Ibrahim","Grade 8","Chemistry",82,100,"82%","B-","6th","2026-09-15","Term 1","Periodic table work"],
            ...
            ["STU025","Ali Hassan El-Gohary","Grade 9","Physics",79,100,"79%","C+","7th","2026-09-15","Term 1","Review Newton laws"],
            ["STU025","Ali Hassan El-Gohary","Grade 9","English",95,100,"95%","A","1st","2026-09-15","Term 1","Best in class"],
            ["STU025","Ali Hassan El-Gohary","Grade 9","Arabic",92,100,"92%","A-","2nd","2026-09-15","Term 1","Strong literature"],
            ["STU025","Ali Hassan El-Gohary","Grade 9","Chemistry",84,100,"84%","B","4th","2026-09-15","Term 1","Good lab work"],
            ["STU027","Marwa Tarek Helmy","Grade 10","Math",91,100,"91%","A-","2nd","2026-09-15","Term 1","Strong trigonometry"],
        ...
        wtab("Fees",["Student ID","Student Name","Grade","Parent Name","Parent Phone","Total Fees","Amount Paid","Remaining","Payment Status","Next Payment Due","Last Payment Date","Days Present","Total School Days"],[
        ...
        wtab("BusRoutes",["Route","Area","Morning Pickup","Arrives School","Departs School","Home Dropoff","Driver Name","Driver Phone","Capacity","Registered","Active"],[
        ...
        wtab("Canteen",["Category","Item","Description","Price (EGP)","Available Days","Allergens","Halal"],[
            ["Main Meal","Koshary","Classic Egyptian koshary with lentils rice pasta",20,"Mon and Wed","Gluten","Yes"],
            ["Main Meal","Macaroni Bechamel","Baked pasta with bechamel sauce and minced meat",22,"Tuesday","Gluten Dairy","Yes"],
            ["Main Meal","Molokhia and Rice","Green molokhia soup with white rice",20,"Wednesday","None","Yes"],
        ...
        wtab("Library",["Book ID","Book Title","Author","Category","Grade Level","Language","Copies","Available","Status","Borrower ID","Due Date","Shelf"],[
            ["LIB001","Harry Potter and the Philosopher Stone","J.K. Rowling","Fantasy","Grade 4-8","English",2,2,"Available","","","Shelf A1"],
        ...
        wtab("Admissions",["Item","Value"],[
            ...
            ["KG1 and KG2 Fees","42000 EGP per year"],
        ...
        wtab("HOW TO USE",["TAB","PURPOSE","WHO UPDATES IT","HOW BOT USES IT","NOTE"],[
        ...
        return jsonify({"status":"ALL DONE","tabs":len(results),"results":results})
    except Exception as e:
        import traceback
