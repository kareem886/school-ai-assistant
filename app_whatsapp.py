...
def setup_form_tab():
    """Rebuild Add Homework tab with a big green SUBMIT button row."""
    import time
    try:
        gc = get_client()
        ...
        # Delete and recreate
        try:
            sh.del_worksheet(sh.worksheet("Add Homework"))
            time.sleep(2)
        except: pass
        ...
        # Colors
        dk   = {"red":0.059,"green":0.110,"blue":0.180}
        navy = {"red":0.118,"green":0.227,"blue":0.373}
        wht  = {"red":1.0,  "green":1.0,  "blue":1.0}
        lblu = {"red":0.941,"green":0.957,"blue":1.0}
        grn  = {"red":0.133,"green":0.545,"blue":0.133}
        lgrn = {"red":0.851,"green":0.969,"blue":0.851}
        mgry = {"red":0.929,"green":0.937,"blue":0.945}
        ...
        reqs = {"requests": [
            # Title banner B2:C2
            {"mergeCells": {"range": {"sheetId":sid,"startRowIndex":1,"endRowIndex":2,"startColumnIndex":1,"endColumnIndex":4}, "mergeType":"MERGE_ALL"}},
            {"repeatCell": {"range": {"sheetId":sid,"startRowIndex":1,"endRowIndex":2,"startColumnIndex":1,"endColumnIndex":4},
            ...
            {"repeatCell": {"range": {"sheetId":sid,"startRowIndex":3,"endRowIndex":10,"startColumnIndex":1,"endColumnIndex":2},
                "cell": {"userEnteredFormat": {"backgroundColor":navy,"textFormat":txt(True,11,wht),"verticalAlignment":"MIDDLE","padding":{"left":8}}},
                "fields": "userEnteredFormat"}},

            # Input cells C4:C10
            {"repeatCell": {"range": {"sheetId":sid,"startRowIndex":3,"endRowIndex":10,"startColumnIndex":2,"endColumnIndex":3},
                "cell": {"userEnteredFormat": {"backgroundColor":lblu,"textFormat":txt(False,11),"verticalAlignment":"MIDDLE","padding":{"left":6}}},
                "fields": "userEnteredFormat"}},

            # ── BIG GREEN SUBMIT BUTTON: row 12 B:C merged ──────────────────
            {"mergeCells": {"range": {"sheetId":sid,"startRowIndex":11,"endRowIndex":12,"startColumnIndex":1,"endColumnIndex":4}, "mergeType":"MERGE_ALL"}},
            {"repeatCell": {"range": {"sheetId":sid,"startRowIndex":11,"endRowIndex":12,"startColumnIndex":1,"endColumnIndex":4},
                "cell": {"userEnteredFormat": {
                    "backgroundColor": grn,
                    "textFormat": {"bold":True,"fontSize":14,"foregroundColor":wht},
                    "verticalAlignment":"MIDDLE",
                    "horizontalAlignment":"CENTER"
                }},
                "fields": "userEnteredFormat"}},

            # Status row 13 — result feedback
            {"mergeCells": {"range": {"sheetId":sid,"startRowIndex":12,"endRowIndex":13,"startColumnIndex":1,"endColumnIndex":4}, "mergeType":"MERGE_ALL"}},
            {"repeatCell": {"range": {"sheetId":sid,"startRowIndex":12,"endRowIndex":13,"startColumnIndex":1,"endColumnIndex":4},
                "cell": {"userEnteredFormat": {"backgroundColor":lgrn,"textFormat":txt(False,10),"verticalAlignment":"MIDDLE","horizontalAlignment":"CENTER"}},
                "fields": "userEnteredFormat"}},
            ...
            {"updateDimensionProperties": {"range": {"sheetId":sid,"dimension":"COLUMNS","startIndex":1,"endIndex":2}, "properties":{"pixelSize":230}, "fields":"pixelSize"}},
            {"updateDimensionProperties": {"range": {"sheetId":sid,"dimension":"COLUMNS","startIndex":2,"endIndex":3}, "properties":{"pixelSize":390}, "fields":"pixelSize"}},
            ...
            # Row heights
            {"updateDimensionProperties": {"range": {"sheetId":sid,"dimension":"ROWS","startIndex":0,"endIndex":1}, "properties":{"pixelSize":12}, "fields":"pixelSize"}},
            ...
            {"updateDimensionProperties": {"range": {"sheetId":sid,"dimension":"ROWS","startIndex":2,"endIndex":3}, "properties":{"pixelSize":12}, "fields":"pixelSize"}},
            {"updateDimensionProperties": {"range": {"sheetId":sid,"dimension":"ROWS","startIndex":3,"endIndex":10}, "properties":{"pixelSize":46}, "fields":"pixelSize"}},
            {"updateDimensionProperties": {"range": {"sheetId":sid,"dimension":"ROWS","startIndex":10,"endIndex":11}, "properties":{"pixelSize":12}, "fields":"pixelSize"}},
            {"updateDimensionProperties": {"range": {"sheetId":sid,"dimension":"ROWS","startIndex":11,"endIndex":12}, "properties":{"pixelSize":60}, "fields":"pixelSize"}},
            {"updateDimensionProperties": {"range": {"sheetId":sid,"dimension":"ROWS","startIndex":12,"endIndex":13}, "properties":{"pixelSize":36}, "fields":"pixelSize"}},

            # Grade dropdown row 5 (index 4)
            ...
            # Subject dropdown row 6 (index 5)
            {"setDataValidation": {"range": {"sheetId":sid,"startRowIndex":5,"endRowIndex":6,"startColumnIndex":2,"endColumnIndex":3},
                "rule": {"condition": {"type":"ONE_OF_LIST","values":[
                    ...
                    {"userEnteredValue":"Music"},{"userEnteredValue":"PE"},{"userEnteredValue":"Activities"},{"userEnteredValue":"Other"},
                ]}, "showCustomUi":True, "strict":False}}},

            # Type dropdown row 9 (index 8)
            ...
            # Hide rows 14+
            {"updateDimensionProperties": {"range": {"sheetId":sid,"dimension":"ROWS","startIndex":13,"endIndex":50},
                "properties":{"hiddenByUser":True}, "fields":"hiddenByUser"}},
        ]}
        ...
        # Status row default text
        s.update("B13", [["👆  Fill in the fields above, then click the green button"]])

        return jsonify({"status": "DONE", "message": "Add Homework tab rebuilt with green submit button"})
    except Exception as e:
        import traceback
